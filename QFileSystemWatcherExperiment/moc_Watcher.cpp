...
**
** Created: Mon May 10 09:35:53 2021
...
static const char qt_meta_stringdata_Watcher[] = {
    "Watcher\0\0path\0StatusChange(QString)\0"
};

const QMetaObject Watcher::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Watcher,
      qt_meta_data_Watcher, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Watcher::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Watcher))
...
int Watcher::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: StatusChange((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
